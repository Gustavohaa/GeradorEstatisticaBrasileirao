...
public class TimeVisitante {
	 private int golsTimeVisitante;
	    ...
	    public TimeVisitante(int golsTimeVisitante, int chutesAGolTimeVisitante, int posseBolaTimeVisitanteDefesaEmMin, int posseBolaTimeVisitanteAtaqueEmMin, int faltasTimeVisitante, int cartoesAmarelosVisitante,int cartoesVermelhosVisitante) {
	        this.golsTimeVisitante = golsTimeVisitante;
	        this.chutesAGolTimeVisitante = chutesAGolTimeVisitante;
	        this.posseBolaTimeVisitanteDefesaEmMin = posseBolaTimeVisitanteDefesaEmMin;
	        this.posseBolaTimeVisitanteAtaqueEmMin = posseBolaTimeVisitanteAtaqueEmMin;
